...
void idcsrs_init(void) {
  ...
  putch(((marchid[0] >> 28) & 0xF));
	putch(((marchid[0] >> 24) & 0xF));
  putch(((marchid[0] >> 20) & 0xF));
	putch(((marchid[0] >> 16) & 0xF));
  putch(((marchid[0] >> 12) & 0xF));
	putch(((marchid[0] >> 8) & 0xF));
  putch(((marchid[0] >> 4) & 0xF));
	putch((marchid[0] & 0xF));
}
