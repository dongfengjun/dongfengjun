...
void bootloader(void) {
	...
	//uint32_t main_saddr = (uint32_t)&main - 0x30000010 + 0x0f000000 + (((size_t)rodata_size + 3) & ~3);
	uint32_t main_saddr = (uint32_t)&main - 0x30000010 + 0x0f000000 + ((size_t)rodata_size) * 4;
