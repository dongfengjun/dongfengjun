...
wire [3:0]IFU_AXI_AWID,IFU_AXI_BID,IFU_AXI_ARID;
wire [3:0]IFU_AXI_AWSIZE,IFU_AXI_ARSIZE;
wire [2:0]IFU_AXI_AWBURST,IFU_AXI_ARBURST;
...
wire [3:0]LSU_AXI_AWID,LSU_AXI_BID,LSU_AXI_ARID;
wire [3:0]LSU_AXI_AWSIZE,LSU_AXI_ARSIZE;
wire [2:0]LSU_AXI_AWBURST,LSU_AXI_ARBURST;
...
wire [3:0]S_AXI_AWID,S_AXI_BID,S_AXI_ARID;
...
wire [3:0]U_AXI_AWID,U_AXI_BID,U_AXI_ARID;
wire [3:0]U_AXI_AWSIZE,U_AXI_ARSIZE;
wire [2:0]U_AXI_AWBURST,U_AXI_ARBURST;
...
wire [3:0]C_AXI_AWID,C_AXI_BID,C_AXI_ARID;
wire [3:0]C_AXI_AWSIZE,C_AXI_ARSIZE;
wire [2:0]C_AXI_AWBURST,C_AXI_ARBURST;
...
ysyx_24110017_IFU IFU(clk,rst,
		...
		IFU_AXI_AWID,IFU_AXI_AWLEN,IFU_AXI_AWSIZE,IFU_AXI_AWBURST,IFU_AXI_WLAST,
		IFU_AXI_WDATA,IFU_AXI_WSTRB,IFU_AXI_WVALID,IFU_AXI_WREADY,
		IFU_AXI_BRESP,IFU_AXI_BVALID,IFU_AXI_BREADY,IFU_AXI_BID,
		IFU_AXI_ARADDR,IFU_AXI_ARVALID,IFU_AXI_ARREADY,
		IFU_AXI_ARID,IFU_AXI_ARLEN,IFU_AXI_ARSIZE,IFU_AXI_ARBURST,
		IFU_AXI_RDATA,IFU_AXI_RRESP,IFU_AXI_RVALID,IFU_AXI_RREADY,
		IFU_AXI_RID,IFU_AXI_RLAST
);
...
ysyx_24110017_LSU LSU(clk,rst,sram_lsu_read,sram_lsu_write,LSU_DONE,
		...
		LSU_AXI_AWID,LSU_AXI_AWLEN,LSU_AXI_AWSIZE,LSU_AXI_AWBURST,LSU_AXI_WLAST,
		LSU_AXI_WDATA,LSU_AXI_WSTRB,LSU_AXI_WVALID,LSU_AXI_WREADY,
    LSU_AXI_BRESP,LSU_AXI_BVALID,LSU_AXI_BREADY,LSU_AXI_BID,
		LSU_AXI_ARADDR,LSU_AXI_ARVALID,LSU_AXI_ARREADY,
		LSU_AXI_ARID,LSU_AXI_ARLEN,LSU_AXI_ARSIZE,LSU_AXI_ARBURST,
		LSU_AXI_RDATA,LSU_AXI_RRESP,LSU_AXI_RVALID,LSU_AXI_RREADY,
		LSU_AXI_RID,LSU_AXI_RLAST
);
