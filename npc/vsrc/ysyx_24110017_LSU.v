...
assign ls_rdata = ((ls_raddr_i % 4 == 0) && op_i == 7'b0000011 && funct3_i == 3'b010) ? ls_rdata_reg
 ...
 : ((ls_raddr_i % 4 == 0) && op_i == 7'b0000011 && funct3_i == 3'b000) ? {{24{ls_rdata_reg[7]}},ls_rdata_reg[7:0]}
 : ((ls_raddr_i % 4 == 1) && op_i == 7'b0000011 && funct3_i == 3'b000) ? {{24{ls_rdata_reg[15]}},ls_rdata_reg[15:8]}
 : ((ls_raddr_i % 4 == 2) && op_i == 7'b0000011 && funct3_i == 3'b000) ? {{24{ls_rdata_reg[23]}},ls_rdata_reg[23:16]}
 : ((ls_raddr_i % 4 == 3) && op_i == 7'b0000011 && funct3_i == 3'b000) ? {{24{ls_rdata_reg[31]}},ls_rdata_reg[31:24]}
 
 : ((ls_raddr_i % 4 == 0) && op_i == 7'b0000011 && funct3_i == 3'b001) ? {{16{ls_rdata_reg[15]}},ls_rdata_reg[15:0]}
 : ((ls_raddr_i % 4 == 1) && op_i == 7'b0000011 && funct3_i == 3'b001) ? {{16{ls_rdata_reg[23]}},ls_rdata_reg[23:8]}
 : ((ls_raddr_i % 4 == 2) && op_i == 7'b0000011 && funct3_i == 3'b001) ? {{16{ls_rdata_reg[31]}},ls_rdata_reg[31:16]}
 : ((ls_raddr_i % 4 == 3) && op_i == 7'b0000011 && funct3_i == 3'b001) ? {{24{ls_rdata_reg[31]}},ls_rdata_reg[31:24]}

 : ((ls_raddr_i % 4 == 0) && op_i == 7'b0000011 && funct3_i == 3'b100) ? {24'b0,ls_rdata_reg[7:0]}
 : ((ls_raddr_i % 4 == 1) && op_i == 7'b0000011 && funct3_i == 3'b100) ? {24'b0,ls_rdata_reg[15:8]}
 : ((ls_raddr_i % 4 == 2) && op_i == 7'b0000011 && funct3_i == 3'b100) ? {24'b0,ls_rdata_reg[23:16]}
 : ((ls_raddr_i % 4 == 3) && op_i == 7'b0000011 && funct3_i == 3'b100) ? {24'b0,ls_rdata_reg[31:24]}
 
 : ((ls_raddr_i % 4 == 0) && op_i == 7'b0000011 && funct3_i == 3'b101) ? {16'b0,ls_rdata_reg[15:0]}
 : ((ls_raddr_i % 4 == 1) && op_i == 7'b0000011 && funct3_i == 3'b101) ? {16'b0,ls_rdata_reg[23:8]}
 : ((ls_raddr_i % 4 == 2) && op_i == 7'b0000011 && funct3_i == 3'b101) ? {16'b0,ls_rdata_reg[31:16]}
 : ((ls_raddr_i % 4 == 3) && op_i == 7'b0000011 && funct3_i == 3'b101) ? {24'b0,ls_rdata_reg[31:24]}
 : 32'b0;
