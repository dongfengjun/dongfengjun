...
wire [3:0] csrs_wen = {
    (op_i == 5'b11100 &&  imm_i[6] && imm_i[2:0] == 3'b101),
    (op_i == 5'b11100 && !imm_i[6] && imm_i[2:0] == 3'b010) || ecall_en,
    (op_i == 5'b11100 &&  imm_i[6] && imm_i[2:0] == 3'b000),
    (op_i == 5'b11100 && !imm_i[6] && imm_i[2:0] == 3'b001) || ecall_en
};
