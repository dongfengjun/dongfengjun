...
assign a = 
	...
	: (((op_i == 5'b01100) && ((funct3_i == 3'b010 && funct7_i == 1'b0)))) ? $signed(r1_i)
	: 32'b0;
assign b = ((op_i == 5'b00100) && (funct3_i == 3'b000 || funct3_i == 3'b001 || funct3_i == 3'b011 || funct3_i == 3'b100 || funct3_i == 3'b110 || funct3_i == 3'b111)) ? imm_i
	...
	: 32'b0;
***/
wire use_r1 = (op_i == 5'b00100) || (op_i == 5'b01100);
wire use_imm = (op_i == 5'b00100);
wire use_shamt = (funct3_i == 3'b001 || funct3_i == 3'b101);
wire use_r2 = (op_i == 5'b01100);
wire use_signed = (funct3_i == 3'b010);
assign a = use_r1 ? (use_signed ? $signed(r1_i) : r1_i) : 32'b0;
assign b = use_imm ? (use_signed ? $signed(imm_i) : use_shamt ? {27'b0, shamt_i} : imm_i) :
           use_r2 ? (use_signed ? $signed(r2_i) : r2_i) : 32'b0;
/***
assign a = (op_i == 5'b00100) ? ((funct3_i == 3'b010) ? $signed(r1_i) : r1_i)
  : (op_i == 5'b01100) ? ((funct3_i == 3'b010 && funct7_i == 1'b0) ? $signed(r1_i) : r1_i)
  : 32'b0;
assign b = (op_i == 5'b00100) ? ((funct3_i == 3'b010) ? $signed(imm_i) : (funct3_i == 3'b001 || funct3_i == 3'b101) ? {27'b0,shamt_i} : imm_i)
  : (op_i == 5'b01100) ? ((funct3_i == 3'b010 && funct7_i == 1'b0) ? $signed(r2_i) : r2_i)
  : 32'b0;
***/
...
assign alu_sel =  ((op_i == 5'b00100 && funct3_i == 3'b000) || (op_i == 5'b01100 && funct3_i == 3'b000 && funct7_i == 1'b0)) ? ADD :
