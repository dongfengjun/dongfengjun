...
wire [3:0]alu_sel =
  ...
  : (funct3_i == 3'b000 && funct7_i == 1'b1) ? SUB
	: (funct3_i == 3'b001) ? SLL
	: (funct3_i == 3'b010 || funct3_i == 3'b011) ? SLT
	: (funct3_i == 3'b100) ? XOR
	: (funct3_i == 3'b101 && funct7_i == 1'b0) ? SRL
	: (funct3_i == 3'b101 && funct7_i == 1'b1) ? SRA
	: (funct3_i == 3'b110) ? OR
	: (funct3_i == 3'b111) ? AND : ADD;
