module EXU_ysyx_24110017(clk,rst,op,sel,imm,funct7,shamt,rd,a,b,csrs,csrs_in,res,ldone);
input clk;
input rst;
input [6:0]op;
input [2:0]sel;
...
/***load*store***/
wire [31:0]rdata;
LSU_ysyx_24110017 LSU_ysyx_24110017(clk,rst,op,rd,a,b,imm,sel,rdata,ldone);
