...
import "DPI-C" function void pmem_write(input int waddr, int wdata, int byte wmask);

assign valid = (op == 7'b0100011 || op == 7'b0000011) ? 1'b1 : 1'b0;
assign wen = (op == 7'b0100011) ? 1'b1 : 1'b0;
assign waddr = (op == 7'b0100011) ? (r1 + offset) : 32'b0;
...
assign wmask = (op == 7'b0100011 || sel == 3'b000) ? 8'b00000001
 ...
 : 8'b0;
assign raddr = r1 + offset; //I_lb~lhu 
