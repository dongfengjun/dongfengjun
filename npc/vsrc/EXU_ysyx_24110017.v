...
assign res = 
      ...
      ({32{sel == 3'b010}} & {32{$signed(a) < $signed(b)}}) |	//slti
	    ({32{sel == 3'b011}} & {32{a < $unsigned(b)}}) |	//sltiu
...
/***R_add~R_remu***/ 
      ...
      ({32{(sel == 3'b000) && (funct7 == 7'b0000000)}} 
			...
			({32{(sel == 3'b000) && (funct7 == 7'b0100000)}} 
					& (a + (((32'b1111_1111_1111_1111_1111_1111_1111_1111)^b)+1))) |	//sub
...
assign waddr = (op == 7'b0100011) ? ((r1 + offset)&(32'b11111111111111111111111111111100)) : 32'h80000000;
...
assign wmask = (op == 7'b0100011 || sel == 3'b000) ? 8'b00000001
 ...
 : 8'b0;
assign raddr = (op == 7'b0000011) ? ((r1 + offset)&(32'b11111111111111111111    111111111100)) : 32'h80000000; //lb~lhu
