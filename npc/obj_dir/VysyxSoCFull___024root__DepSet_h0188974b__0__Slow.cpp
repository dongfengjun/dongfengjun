...
VL_ATTR_COLD void VysyxSoCFull___024root___dump_triggers__act(VysyxSoCFull___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(7U)) {
        VL_DBG_MSGF("         'act' region trigger index 7 is active: @([changed] ysyxSoCFull.psram.ren or [changed] ysyxSoCFull.psram.wen)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VysyxSoCFull___024root___dump_triggers__nba(VysyxSoCFull___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(7U)) {
        VL_DBG_MSGF("         'nba' region trigger index 7 is active: @([changed] ysyxSoCFull.psram.ren or [changed] ysyxSoCFull.psram.wen)\n");
    }
}
#endif  // VL_DEBUG
