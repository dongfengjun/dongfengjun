...
void Vtop_ysyx_24110017___024root__trace_chg_sub_0(Vtop_ysyx_24110017___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+22,(vlSelf->top_ysyx_24110017__DOT__PCU__DOT__ecall_en));
        bufp->chgIData(oldp+23,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[0]),32);
        bufp->chgIData(oldp+24,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[1]),32);
        bufp->chgIData(oldp+25,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[2]),32);
        bufp->chgIData(oldp+26,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[3]),32);
        bufp->chgIData(oldp+27,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[4]),32);
        bufp->chgIData(oldp+28,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[5]),32);
        bufp->chgIData(oldp+29,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[6]),32);
        bufp->chgIData(oldp+30,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[7]),32);
        bufp->chgIData(oldp+31,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[8]),32);
        bufp->chgIData(oldp+32,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[9]),32);
        bufp->chgIData(oldp+33,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[10]),32);
        bufp->chgIData(oldp+34,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[11]),32);
        bufp->chgIData(oldp+35,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[12]),32);
        bufp->chgIData(oldp+36,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[13]),32);
        bufp->chgIData(oldp+37,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[14]),32);
        bufp->chgIData(oldp+38,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[15]),32);
        bufp->chgIData(oldp+39,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[16]),32);
        bufp->chgIData(oldp+40,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[17]),32);
        bufp->chgIData(oldp+41,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[18]),32);
        bufp->chgIData(oldp+42,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[19]),32);
        bufp->chgIData(oldp+43,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[20]),32);
        bufp->chgIData(oldp+44,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[21]),32);
        bufp->chgIData(oldp+45,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[22]),32);
        bufp->chgIData(oldp+46,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[23]),32);
        bufp->chgIData(oldp+47,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[24]),32);
        bufp->chgIData(oldp+48,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[25]),32);
        bufp->chgIData(oldp+49,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[26]),32);
        bufp->chgIData(oldp+50,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[27]),32);
        bufp->chgIData(oldp+51,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[28]),32);
        bufp->chgIData(oldp+52,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[29]),32);
        bufp->chgIData(oldp+53,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[30]),32);
        bufp->chgIData(oldp+54,(vlSelf->top_ysyx_24110017__DOT__RF__DOT__rf[31]),32);
    }
    bufp->chgBit(oldp+55,(vlSelf->top_ysyx_24110017__02Eclk));
    bufp->chgBit(oldp+56,(vlSelf->rst));
    bufp->chgIData(oldp+57,(vlSelf->pc),32);
    bufp->chgIData(oldp+58,(vlSelf->dnpc),32);
    bufp->chgIData(oldp+59,(vlSelf->inst),32);
    bufp->chgBit(oldp+60,(vlSelf->Sta_RegisterFile__02Eclk));
    bufp->chgIData(oldp+61,(vlSelf->wdata),32);
    bufp->chgCData(oldp+62,(vlSelf->waddr),8);
    bufp->chgBit(oldp+63,(vlSelf->wen));
    bufp->chgCData(oldp+64,(vlSelf->raddr1),8);
    bufp->chgIData(oldp+65,(vlSelf->r1),32);
    bufp->chgCData(oldp+66,((0x7fU & vlSelf->inst)),7);
    bufp->chgCData(oldp+67,(((IData)(vlSelf->top_ysyx_24110017__DOT__wr_en)
                              ? (0x1fU & (vlSelf->inst 
                                          >> 7U)) : 0U)),5);
    bufp->chgCData(oldp+68,((7U & (vlSelf->inst >> 0xcU))),3);
    bufp->chgCData(oldp+69,(((IData)(vlSelf->top_ysyx_24110017__DOT__IDU__DOT____VdfgTmp_hcbe0b758__0)
                              ? (0x1fU & (vlSelf->inst 
                                          >> 0x14U))
                              : 0U)),5);
    bufp->chgCData(oldp+70,((0x1fU & (vlSelf->inst 
                                      >> 0x14U))),5);
    bufp->chgIData(oldp+71,((((3U == (0x7fU & vlSelf->inst)) 
                                  ...
                                  : ((0x67U == (0x7fU 
                                      ...
                                      : ((0x37U == 
                                          ...
                                          : ((0x17U 
                                              ...
                                              : 0U)))))),32);
    bufp->chgIData(oldp+72,(((IData)(vlSelf->top_ysyx_24110017__DOT__PCU__DOT__ecall_en)
    ...
    bufp->chgIData(oldp+76,(((0x23U == (0x7fU & vlSelf->inst))
                              ? vlSelf->top_ysyx_24110017__DOT__EXU__DOT____VdfgTmp_hd43fef8a__0
                              : 0x80000000U)),32);
    bufp->chgIData(oldp+77,(((0x23U == (0x7fU & vlSelf->inst))
                              ? vlSelf->top_ysyx_24110017__DOT__r2
                              : 0U)),32);
    bufp->chgCData(oldp+78,(((IData)((0x23U == (0x707fU 
                                                & vlSelf->inst)))
                              ? 1U : ((IData)((0x1023U 
                                               == (0x707fU 
                                                   & vlSelf->inst)))
                                           ...
                                           | ((0xff000U 
                                              ...
                                              | ((0x800U 
                                                 ...
                                                 | (0x7feU 
                                                    & (vlSelf->inst 
                                                       >> 0x14U))))))),32);
    bufp->chgBit(oldp+84,((0U != vlSelf->pc)));
    bufp->chgBit(oldp+85,((0x6fU == (0x7fU & vlSelf->inst))));
    bufp->chgBit(oldp+86,((0x67U == (0x7fU & vlSelf->inst))));
    ...
    bufp->chgBit(oldp+92,((IData)(((0x7063U == (0x707fU 
                                   ...
                                   & (vlSelf->top_ysyx_24110017__DOT__r1 
                                      >= vlSelf->top_ysyx_24110017__DOT__r2)))));
    bufp->chgBit(oldp+93,((IData)(((0x73U == (0x707fU 
                                              & vlSelf->inst)) 
