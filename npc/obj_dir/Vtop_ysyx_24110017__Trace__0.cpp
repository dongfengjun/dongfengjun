...
void Vtop_ysyx_24110017___024root__trace_chg_sub_0(Vtop_ysyx_24110017___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+20,((0x1fU & vlSelf->top_ysyx_24110017__DOT__imm)),5);
    ...
    bufp->chgCData(oldp+60,((0x7fU & vlSelf->inst)),7);
    bufp->chgCData(oldp+61,(((IData)(vlSelf->top_ysyx_24110017__DOT__wr_en)
                              ? (0x1fU & (vlSelf->inst 
                                          >> 7U)) : 0U)),5);
    bufp->chgCData(oldp+62,((7U & (vlSelf->inst >> 0xcU))),3);
    bufp->chgCData(oldp+63,((((0x33U == (0x7fU & vlSelf->inst)) 
    ...
    bufp->chgIData(oldp+67,((((0x33U == (0x7fU & vlSelf->inst)) 
                              | (0x13U == (0x7fU & vlSelf->inst)))
                              ? (vlSelf->inst >> 0x19U)
                              : 0U)),32);
    bufp->chgCData(oldp+68,((0x1fU & (vlSelf->inst 
                                      >> 0x14U))),7);
    ...
    bufp->chgIData(oldp+72,(((0x23U == (0x7fU & vlSelf->inst))
                              ? vlSelf->top_ysyx_24110017__DOT__EXU__DOT__LSU_ysyx_24110017__DOT____VdfgTmp_hd43fef8a__0
                              : 0x80000000U)),32);
    bufp->chgIData(oldp+73,(((0x23U == (0x7fU & vlSelf->inst))
                              ? vlSelf->top_ysyx_24110017__DOT__b
                              : 0U)),32);
    bufp->chgCData(oldp+74,(((IData)((0x23U == (0x707fU 
                                                & vlSelf->inst)))
                              ? 1U : ((IData)((0x1023U 
                                               == (0x707fU 
                                                   & vlSelf->inst)))
    ...
    bufp->chgBit(oldp+81,((0x67U == (0x7fU & vlSelf->inst))));
    ...
    bufp->chgBit(oldp+87,((IData)(((0x7063U == (0x707fU 
                                   ...
                                   & (vlSelf->top_ysyx_24110017__DOT__r1 
                                      >= vlSelf->top_ysyx_24110017__DOT__r2)))));
    bufp->chgBit(oldp+88,((IData)(((0x73U == (0x707fU 
                                              & vlSelf->inst)) 
