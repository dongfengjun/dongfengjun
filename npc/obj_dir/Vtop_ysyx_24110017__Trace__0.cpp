...
void Vtop_ysyx_24110017___024root__trace_chg_sub_0(Vtop_ysyx_24110017___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgCData(oldp+0,((1U & vlSelf->top_ysyx_24110017__DOT____Vcellout__IFU____pinNumber2)),7);
        bufp->chgBit(oldp+1,((1U & vlSelf->top_ysyx_24110017__DOT____Vcellout__IFU____pinNumber2)));
        bufp->chgIData(oldp+2,((1U & vlSelf->top_ysyx_24110017__DOT____Vcellout__IFU____pinNumber2)),32);
        bufp->chgIData(oldp+3,(0U),32);
        bufp->chgIData(oldp+4,(vlSelf->top_ysyx_24110017__DOT____Vcellout__IFU____pinNumber2),32);
    }
