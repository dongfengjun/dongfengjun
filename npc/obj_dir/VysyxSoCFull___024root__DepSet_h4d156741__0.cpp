...
void VysyxSoCFull___024root___eval_triggers__act(VysyxSoCFull___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.at(0xaU) = (((~ (IData)(vlSelf->clock)) 
                                         & (IData)(vlSelf->__Vtrigrprev__TOP__clock)) 
                                        | ((IData)(vlSelf->ysyxSoCFull__DOT__sdram__DOT__reset) 
                                           & (~ (IData)(vlSelf->__Vtrigrprev__TOP__ysyxSoCFull__DOT__sdram__DOT__reset))));
    ...
    vlSelf->__Vtrigrprev__TOP__ysyxSoCFull__DOT__sdram__DOT__reset 
        = vlSelf->ysyxSoCFull__DOT__sdram__DOT__reset;
...
VL_INLINE_OPT void VysyxSoCFull___024root___nba_sequent__TOP__4(VysyxSoCFull___024root* vlSelf) {
    ...
    if (vlSelf->ysyxSoCFull__DOT__asic__DOT____Vcellinp__cpu__reset) {
        vlSelf->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__ysyx_24110017_CLINT__DOT__mtime = 0ULL;
