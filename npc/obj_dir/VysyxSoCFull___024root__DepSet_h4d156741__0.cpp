...
void VysyxSoCFull___024root____Vdpiexp_ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__performance_counter_TOP(VysyxSoCFull__Syms* __restrict vlSymsp, IData/*31:0*/ i, IData/*31:0*/ &performance_counter__Vfuncrtn) {
    ...
    // Init
    // Body
    performance_counter__Vfuncrtn = (IData)(((0U == i)
                                              ? (QData)((IData)(
                                                        ...
                                                        ((9U 
                                                         ...
                                                         ((0xaU 
                                                          ...
                                                          ((0xbU 
                                                           ...
                                                           ((0xcU 
                                                             == i)
                                                             ? (QData)((IData)(vlSymsp->TOP.ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__isCHazard))
                                                             : 
                                                            ((0xdU 
                                                              == i)
                                                              ? (QData)((IData)(vlSymsp->TOP.ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__if_valid))
                                                              : 
                                                             ((0xeU 
                                                               == i)
                                                               ? (QData)((IData)(
