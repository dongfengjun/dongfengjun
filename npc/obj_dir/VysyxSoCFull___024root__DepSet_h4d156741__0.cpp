...
VL_INLINE_OPT void VysyxSoCFull___024root___nba_sequent__TOP__7(VysyxSoCFull___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ __Vtask_psram_read__3__data;
    __Vtask_psram_read__3__data = 0;
    // Body
    if (((0xebU == (IData)(vlSelf->ysyxSoCFull__DOT__psram__DOT__cmd)) 
         & ((1U == (IData)(vlSelf->ysyxSoCFull__DOT__psram__DOT__state)) 
            & (5U == (IData)(vlSelf->ysyxSoCFull__DOT__psram__DOT__counter))))) {
        if (VL_LIKELY((0xebU == (IData)(vlSelf->ysyxSoCFull__DOT__psram__DOT__cmd)))) {
            VysyxSoCFull___024unit____Vdpiimwrap_psram_read_TOP____024unit(vlSelf->ysyxSoCFull__DOT__psram__DOT__addr, __Vtask_psram_read__3__data);
            vlSelf->ysyxSoCFull__DOT__psram__DOT__rdata 
                = __Vtask_psram_read__3__data;
        } else {
            VL_FWRITEF(0x80000002U,"Assertion failed: Unsupport command `%xh`, only support `EBh` read command\n",
                       8,vlSelf->ysyxSoCFull__DOT__psram__DOT__cmd);
            if (0x80000002U) { VL_FFLUSH_I(0x80000002U); }
            VL_WRITEF("[%0t] %%Error: psram.v:112: Assertion failed in %NysyxSoCFull.psram.psram_cmd_i\n",
                      64,VL_TIME_UNITED_Q(1000),-9,
                      vlSymsp->name());
            Verilated::runFlushCallbacks();
            VL_STOP_MT("../ysyxSoC/perip/psram/psram.v", 112, "");
        }
        ...
        if (VL_LIKELY((0x38U == (IData)(vlSelf->ysyxSoCFull__DOT__psram__DOT__cmd)))) {
            VysyxSoCFull___024unit____Vdpiimwrap_psram_write_TOP____024unit(vlSelf->ysyxSoCFull__DOT__psram__DOT__addr, vlSelf->ysyxSoCFull__DOT__psram__DOT__wdata);
        } else {
            VL_FWRITEF(0x80000002U,"Assertion failed: Unsupport command `%xh`, only     support `38h` write command\n",
                       8,vlSelf->ysyxSoCFull__DOT__psram__DOT__cmd);
            if (0x80000002U) { VL_FFLUSH_I(0x80000002U); }
            VL_WRITEF("[%0t] %%Error: psram.v:119: Assertion failed in %NysyxSoCFull.psram.psram_cmd_i\n",
                      64,VL_TIME_UNITED_Q(1000),-9,
                      vlSymsp->name());
            Verilated::runFlushCallbacks();
            VL_STOP_MT("../ysyxSoC/perip/psram/psram.v", 119, "");
        }
    }
}
