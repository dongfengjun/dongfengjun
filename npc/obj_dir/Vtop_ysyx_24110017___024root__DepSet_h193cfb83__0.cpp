...
VL_INLINE_OPT void Vtop_ysyx_24110017___024root___ico_sequent__TOP__0(Vtop_ysyx_24110017___024root* vlSelf) {
    ...
    vlSelf->top_ysyx_24110017__DOT__sel = ((IData)(
                                                   (0x13U 
                                                    == 
                                                    (0x707fU 
                                                     & vlSelf->inst)))
                                            ? 1U : 0U);
    vlSelf->top_ysyx_24110017__DOT__r1 = ((0U == (0x1fU 
                                                  & (vlSelf->inst 
                                                     >> 0xfU)))
                                          ...
                                          [(0x1fU & 
                                            (vlSelf->inst 
                                             >> 0xfU))]);
    vlSelf->top_ysyx_24110017__DOT__IDU__DOT__immI 
        = (((- (IData)((vlSelf->inst >> 0x1fU))) << 0xcU) 
           | (vlSelf->inst >> 0x14U));
    if ((0x13U == (0x7fU & vlSelf->inst))) {
        vlSelf->top_ysyx_24110017__DOT__a = vlSelf->top_ysyx_24110017__DOT__r1;
        vlSelf->top_ysyx_24110017__DOT__imm = vlSelf->top_ysyx_24110017__DOT__IDU__DOT__immI;
    } else {
        vlSelf->top_ysyx_24110017__DOT__a = vlSelf->pc;
        vlSelf->top_ysyx_24110017__DOT__imm = (0xfffff000U 
                                               & vlSelf->inst);
    }
    if ((0x6fU == (0x7fU & vlSelf->inst))) {
        vlSelf->top_ysyx_24110017__DOT__offset = ((
                                                   (- (IData)(
                                                              (vlSelf->inst 
                                                               >> 0x1fU))) 
                                                   << 0x15U) 
                                                     ...
                                                     | ((0xff000U 
                                                        ...
                                                        | ((0x800U 
                                                           ...
                                                           | (0x7feU 
                                                              & (vlSelf->inst 
                                                                 >> 0x14U))))));
        vlSelf->dnpc = (vlSelf->top_ysyx_24110017__DOT__offset 
                        + vlSelf->pc);
    } else {
        vlSelf->top_ysyx_24110017__DOT__offset = vlSelf->top_ysyx_24110017__DOT__IDU__DOT__immI;
        vlSelf->dnpc = ((0x67U == (0x7fU & vlSelf->inst))
                         ? (0xfffffffeU & (vlSelf->top_ysyx_24110017__DOT__offset 
...
VL_INLINE_OPT void Vtop_ysyx_24110017___024root___nba_sequent__TOP__0(Vtop_ysyx_24110017___024root* vlSelf) {
    ...
    __Vdly__pc = ((IData)(vlSelf->rst) ? 0x80000000U
                   : ((0x6fU == (0x7fU & vlSelf->inst))
                       ? (vlSelf->pc + vlSelf->top_ysyx_24110017__DOT__offset)
                       : ((0x67U == (0x7fU & vlSelf->inst))
                           ? (0xfffffffeU & (vlSelf->top_ysyx_24110017__DOT__r1 
                                             + vlSelf->top_ysyx_24110017__DOT__offset))
                           : ((IData)(4U) + vlSelf->pc))));
    if (((0x13U == (0x7fU & vlSelf->inst)) | ((0x17U 
                                               == (0x7fU 
                                                   & vlSelf->inst)) 
                                              | ((0x6fU 
                                                  == 
        ...
        __Vdlyvval__top_ysyx_24110017__DOT__RF__DOT__rf__v0 
            = ((0x6fU == (0x7fU & vlSelf->inst)) ? 
               ((IData)(4U) + vlSelf->pc) : vlSelf->top_ysyx_24110017__DOT__res);
