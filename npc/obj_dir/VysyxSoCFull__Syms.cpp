    ...
    , TOP____024unit{this, Verilated::catName(namep, "$unit")}
{
    ...
    __Vscope_ysyxSoCFull__asic__cpu__cpu__ICACHE.configure(this, name(), "ysyxSoCFull.asic.cpu.cpu.ICACHE", "ICACHE", -9, VerilatedScope::SCOPE_OTHER);
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        ...
        __Vscope_ysyxSoCFull__asic__cpu__cpu.exportInsert(__Vfinal, "performance_counter", (void*)(&VysyxSoCFull___024root____Vdpiexp_ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__performance_counter_TOP));
        __Vscope_ysyxSoCFull__asic__cpu__cpu__ICACHE.exportInsert(__Vfinal, "amat_counter", (void*)(&VysyxSoCFull___024root____Vdpiexp_ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__ICACHE__DOT__amat_counter_TOP));
