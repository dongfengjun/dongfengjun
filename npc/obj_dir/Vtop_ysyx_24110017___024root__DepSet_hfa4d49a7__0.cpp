...
void Vtop_ysyx_24110017___024root____Vdpiexp_top_ysyx_24110017__DOT__GPRs__DOT__gpr_reg_display_TOP(Vtop_ysyx_24110017__Syms* __restrict vlSymsp, IData/*31:0*/ addr, IData/*31:0*/ &gpr_reg_display__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_ysyx_24110017___024root____Vdpiexp_top_ysyx_24110017__DOT__GPRs__DOT__gpr_reg_display_TOP\n"); );
    // Init
    // Body
    gpr_reg_display__Vfuncrtn = ((0U == addr) ? 0U : 
                                 vlSymsp->TOP.top_ysyx_24110017__DOT__GPRs__DOT__rf
                                 [(0x1fU & addr)]);
}
