...
int VysyxSoCTop::csr_display(int i) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCTop___024root::csr_display\n"); );
    // Init
    IData/*31:0*/ i__Vcvt;
    i__Vcvt = 0;
    ...
    VysyxSoCTop__Vcb_csr_display_t __Vcb = (VysyxSoCTop__Vcb_csr_display_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    i__Vcvt = i;
    (*__Vcb)((VysyxSoCTop__Syms*)(__Vscopep->symsp()), i__Vcvt, csr_display__Vfuncrtn__Vcvt);
...
int VysyxSoCTop::gpr_reg_display(int addr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCTop___024root::gpr_reg_display\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCTop__Vcb_gpr_reg_display_t __Vcb = (VysyxSoCTop__Vcb_gpr_reg_display_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    addr__Vcvt = addr;
    (*__Vcb)((VysyxSoCTop__Syms*)(__Vscopep->symsp()), addr__Vcvt, gpr_reg_display__Vfuncrtn__Vcvt);
