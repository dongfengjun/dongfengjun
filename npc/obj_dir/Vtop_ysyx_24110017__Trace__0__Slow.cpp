...
VL_ATTR_COLD void Vtop_ysyx_24110017___024root__trace_init_sub__TOP__0(Vtop_ysyx_24110017___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+38,"pc", false,-1, 31,0);
    tracep->declBus(c+39,"inst", false,-1, 31,0);
    tracep->declBus(c+40,"op", false,-1, 6,0);
    ...
    tracep->declBit(c+44,"jalen", false,-1);
    tracep->declBit(c+45,"jalren", false,-1);
    tracep->declBus(c+46,"res", false,-1, 31,0);
    tracep->declBus(c+47,"r1", false,-1, 31,0);
    tracep->declBus(c+48,"a", false,-1, 31,0);
    tracep->declBus(c+1,"b", false,-1, 31,0);
    tracep->declBus(c+49,"xrd", false,-1, 31,0);
    ...
    tracep->declBus(c+47,"rdata", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
...
VL_ATTR_COLD void Vtop_ysyx_24110017___024root__trace_full_sub_0(Vtop_ysyx_24110017___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+42,((0x1fU & (vlSelf->inst 
                                       >> 0xfU))),5);
    bufp->fullBit(oldp+43,(((0x13U == (0x7fU & vlSelf->inst)) 
                            | ((0x17U == (0x7fU & vlSelf->inst)) 
                               | ((0x6fU == (0x7fU 
                                             & vlSelf->inst)) 
                                  | (0x67U == (0x7fU 
                                               & vlSelf->inst)))))));
    bufp->fullBit(oldp+44,((0x6fU == (0x7fU & vlSelf->inst))));
    bufp->fullBit(oldp+45,((0x67U == (0x7fU & vlSelf->inst))));
    bufp->fullIData(oldp+46,((vlSelf->top_ysyx_24110017__DOT__a 
                              + vlSelf->top_ysyx_24110017__DOT__imm)),32);
    bufp->fullIData(oldp+47,(vlSelf->top_ysyx_24110017__DOT__r1),32);
    bufp->fullIData(oldp+48,(vlSelf->top_ysyx_24110017__DOT__a),32);
    bufp->fullIData(oldp+49,(((0x6fU == (0x7fU & vlSelf->inst))
                               ? ((IData)(4U) + vlSelf->pc)
                               : (vlSelf->top_ysyx_24110017__DOT__a 
                                  + vlSelf->top_ysyx_24110017__DOT__imm))),32);
    bufp->fullCData(oldp+50,((7U & (vlSelf->inst >> 0xcU))),3);
    bufp->fullIData(oldp+51,((0xfffff000U & vlSelf->inst)),32);
