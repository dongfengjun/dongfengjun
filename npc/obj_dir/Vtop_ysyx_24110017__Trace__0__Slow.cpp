...
VL_ATTR_COLD void Vtop_ysyx_24110017___024root__trace_init_sub__TOP__0(Vtop_ysyx_24110017___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+63,"IFU_READY", false,-1);
    tracep->declBit(c+137,"pc_valid", false,-1);
    ...
    tracep->declBit(c+138,"next_state", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+139,"s_rdata", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vtop_ysyx_24110017___024root__trace_full_sub_0(Vtop_ysyx_24110017___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+100,((0x80000000U < vlSelf->dnpc)));
    ...
    bufp->fullBit(oldp+137,(vlSelf->top_ysyx_24110017__DOT__PCU__DOT__pc_valid));
    bufp->fullBit(oldp+138,(vlSelf->top_ysyx_24110017__DOT__PCU__DOT__next_state));
    bufp->fullIData(oldp+139,(vlSelf->top_ysyx_24110017__DOT__SRAM_LSU_ysyx_24110017__DOT__s_rdata),32);
