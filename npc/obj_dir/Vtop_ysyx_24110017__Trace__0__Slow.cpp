...
VL_ATTR_COLD void Vtop_ysyx_24110017___024root__trace_init_sub__TOP__0(Vtop_ysyx_24110017___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+15,"valid", false,-1);
    ...
    tracep->declBus(c+13,"immS", false,-1, 31,0);
    ...
    tracep->declBit(c+10,"ifen", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+15,"jalen", false,-1);
    tracep->declBit(c+15,"jalren", false,-1);
    tracep->declBit(c+15,"beqen", false,-1);
    tracep->declBit(c+15,"bneen", false,-1);
    tracep->declBit(c+15,"blten", false,-1);
    tracep->declBit(c+15,"bgeen", false,-1);
    tracep->declBit(c+15,"bltuen", false,-1);
    tracep->declBit(c+15,"bgeuen", false,-1);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vtop_ysyx_24110017___024root__trace_full_sub_0(Vtop_ysyx_24110017___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+10,((0U != vlSelf->pc)));
    bufp->fullCData(oldp+11,(0U),5);
    bufp->fullCData(oldp+12,(0U),3);
    bufp->fullIData(oldp+13,(0U),32);
    bufp->fullCData(oldp+14,(0U),7);
    bufp->fullBit(oldp+15,(0U));
    bufp->fullIData(oldp+16,(0x80000000U),32);
