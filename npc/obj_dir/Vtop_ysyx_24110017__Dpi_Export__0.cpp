...
int Vtop_ysyx_24110017::gpr_reg_display(int addr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_ysyx_24110017___024root::gpr_reg_display\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vtop_ysyx_24110017__Vcb_gpr_reg_display_t __Vcb = (Vtop_ysyx_24110017__Vcb_gpr_reg_display_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    addr__Vcvt = addr;
    (*__Vcb)((Vtop_ysyx_24110017__Syms*)(__Vscopep->symsp()), addr__Vcvt, gpr_reg_display__Vfuncrtn__Vcvt);
