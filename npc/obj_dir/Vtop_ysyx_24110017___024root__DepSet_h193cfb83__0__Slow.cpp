...
VL_ATTR_COLD void Vtop_ysyx_24110017___024root___stl_sequent__TOP__0(Vtop_ysyx_24110017___024root* vlSelf) {
    ...
    if (((IData)((0x5013U == (0x707fU & vlSelf->inst))) 
        ...
        vlSelf->top_ysyx_24110017__DOT__EXU__DOT__test1 = 1U;
    }
    if ((1U & (~ ((IData)((0x5013U == (0x707fU & vlSelf->inst))) 
                  & (0U == (IData)(vlSelf->top_ysyx_24110017__DOT__funct7)))))) {
        if (((IData)((0x5013U == (0x707fU & vlSelf->inst))) 
             & (0x20U == (IData)(vlSelf->top_ysyx_24110017__DOT__funct7)))) {
            vlSelf->top_ysyx_24110017__DOT__EXU__DOT__test2 = 1U;
        }
    }
...
VL_ATTR_COLD void Vtop_ysyx_24110017___024root___ctor_var_reset(Vtop_ysyx_24110017___024root* vlSelf) {
    ...
    vlSelf->top_ysyx_24110017__DOT__EXU__DOT__test1 = VL_RAND_RESET_I(1);
    vlSelf->top_ysyx_24110017__DOT__EXU__DOT__test2 = VL_RAND_RESET_I(1);
