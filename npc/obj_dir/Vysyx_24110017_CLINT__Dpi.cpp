...
//    1. Call Vysyx_24110017_CLINT::{export_function} instead,
//       and do not even bother to compile this file
// or 2. Compile all __Dpi.cpp files in the same compiler run,
//       and #ifdefs already inserted here will sort everything out.

#include "Vysyx_24110017_CLINT__Dpi.h"
...
int csr_display(int i) {
    ...
    return Vysyx_24110017_CLINT::csr_display(i);
}
#endif
...
int gpr_reg_display(int addr) {
    ...
    return Vysyx_24110017_CLINT::gpr_reg_display(addr);
}
#endif
