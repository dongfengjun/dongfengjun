...
extern "C" {
    ...
    // DPI EXPORTS
    // DPI export at vsrc/ysyx_24110017_CACHE.v:274:15
    extern int amat_counter(int i);
    // DPI export at vsrc/ysyx_24110017.v:280:14
    extern int csr_grab(int i);
    // DPI export at vsrc/ysyx_24110017.v:287:14
    extern int dpic_grab(int i);
    // DPI export at vsrc/ysyx_24110017_RegisterFile.v:24:14
    extern int gpr_reg_grab(int addr);
    // DPI export at vsrc/ysyx_24110017.v:297:14
    extern int performance_counter(int i);

    // DPI IMPORTS
    // DPI import at vsrc/ysyx_24110017_LSU.v:140:30
    ...
    // DPI import at vsrc/ysyx_24110017_IDU.v:197:30
