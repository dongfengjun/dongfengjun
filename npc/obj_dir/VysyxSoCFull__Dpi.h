...
extern "C" {
    ...
    // DPI EXPORTS
    // DPI export at vsrc/ysyx_24110017_CACHE.v:239:15
    extern int amat_counter(int i);
    // DPI export at vsrc/ysyx_24110017.v:309:14
    extern int csr_grab(int i);
    // DPI export at vsrc/ysyx_24110017.v:316:14
    extern int dpic_grab(int i);
    // DPI export at vsrc/ysyx_24110017_RegisterFile.v:24:14
    extern int gpr_reg_grab(int addr);
    // DPI export at vsrc/ysyx_24110017.v:325:14
    extern int performance_counter(int i);

    // DPI IMPORTS
    // DPI import at vsrc/ysyx_24110017_LSU.v:203:30
    ...
    // DPI import at vsrc/ysyx_24110017.v:301:30
