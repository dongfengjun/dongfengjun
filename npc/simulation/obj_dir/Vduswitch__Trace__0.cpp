...
void Vduswitch___024root__trace_chg_sub_0(Vduswitch___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vduswitch___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vduswitch___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vduswitch___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vduswitch___024root__trace_chg_sub_0(Vduswitch___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vduswitch__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vduswitch___024root__trace_chg_sub_0\n"); );
    // Init
...
void Vduswitch___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vduswitch___024root__trace_cleanup\n"); );
    // Init
    Vduswitch___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vduswitch___024root*>(voidSelf);
    Vduswitch__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
